<script lang="ts">
    ...
    import '$assets/css/theme-beige.css';
                            ...
                            <div class="menu-category-content">
                                ...
                                <div class="menu-item menu-list-item">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-sm-6 text-sm-right">
                                            <span class="text-md mr-4"><span class="text-muted">from</span> $<span data-product-base-price>14.00</span></span>
                                ...
                                <div class="menu-item menu-list-item">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-sm-6 text-sm-right">
                                            <span class="text-md mr-4"><span class="text-muted">from</span> $<span data-product-base-price>13.00</span></span>
